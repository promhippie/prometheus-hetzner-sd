...
func Server(cfg *config.Config) *cli.Command {
	return &cli.Command{
		...
		Action: func(_ context.Context, cmd *cli.Command) error {
			...
			if cmd.IsSet("hetzner.username") && cmd.IsSet("hetzner.password") {
				credentials := config.Credential{
					Project:  "default",
					Username: cmd.String("hetzner.username"),
					Password: cmd.String("hetzner.password"),
				}
...
func ServerFlags(cfg *config.Config) []cli.Flag {
	return []cli.Flag{
		...
		&cli.StringFlag{
			...
			Sources:     cli.EnvVars("PROMETHEUS_HETZNER_WEB_PATH"),
		...
		&cli.StringFlag{
			...
			Sources:     cli.EnvVars("PROMETHEUS_HETZNER_WEB_CONFIG"),
		...
		&cli.StringFlag{
			...
			Sources:     cli.EnvVars("PROMETHEUS_HETZNER_OUTPUT_ENGINE"),
		...
		&cli.StringFlag{
			...
			Sources:     cli.EnvVars("PROMETHEUS_HETZNER_OUTPUT_FILE"),
		...
		&cli.IntFlag{
			...
			Sources:     cli.EnvVars("PROMETHEUS_HETZNER_OUTPUT_REFRESH"),
		...
		&cli.StringFlag{
			...
			Sources: cli.EnvVars("PROMETHEUS_HETZNER_USERNAME"),
		},
		&cli.StringFlag{
			Name:    "hetzner.password",
			Value:   "",
			Usage:   "Password for the Hetzner API",
			Sources: cli.EnvVars("PROMETHEUS_HETZNER_PASSWORD"),
		},
		&cli.StringFlag{
			Name:    "hetzner.config",
			Value:   "",
